...
<head>
    ...
    <title>Ajouter Catégorie - Admin</title>
            ...
            <div class="admin-card admin-shadow-lg">
                ...
                <div class="admin-card-body">
                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="mb-3">
                            <label for="nom" class="admin-form-label">Nom de la Catégorie</label>
                            <input type="text" class="form-control admin-form-control" id="nom" name="nom" value="{{ old('nom') }}" required>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.categories.index') }}" class="btn btn-admin-secondary">⬅ Retour</a>
