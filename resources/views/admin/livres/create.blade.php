                    ...
                    <form method="POST" action="{{ route('admin.livres.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control admin-form-control" id="titre" name="titre" value="{{ old('titre') }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="auteur" class="admin-form-label">Auteur</label>
                                <input type="text" class="form-control admin-form-control" id="auteur" name="auteur" value="{{ old('auteur') }}" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="admin-form-label">Description</label>
                            <textarea class="form-control admin-form-control" id="description" name="description" rows="3">{{ old('description') }}</textarea>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="date_publication" class="admin-form-label">Date de Publication</label>
                                <input type="date" class="form-control admin-form-control" id="date_publication" name="date_publication" value="{{ old('date_publication') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            <label for="image" class="admin-form-label">Image (optionnel)</label>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-admin-success">Enregistrer</button>
                        </div>
                    </form>
                </div>
            </div>
